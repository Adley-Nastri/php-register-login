<ul>
   ...
   <li><a href='http://bitsandbytez.co.uk/about'><span>About</span></a></li>
   <li><a href='http://bitsandbytez.co.uk/users'><span>Users</span></a></li>
   <li><a href='http://bitsandbytez.co.uk/comment'><span>Comment</span></a></li>
   <li><a href='http://bitsandbytez.co.uk/store'><span>Store</span></a></li>
   <li class='active has-sub'><a href='#'><span>Logged in as <?php echo $user_data['Username']; ?></span></a>
	...
	<?php
      ...
      <ul>
         <li class='has-sub'><a href='http://bitsandbytez.co.uk/admin'><span>Admin Control Panel
